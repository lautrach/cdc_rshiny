...
server <- function(input, output, session) {
  ...
  output$recommendation <- renderText({
    ...
    sprintf('<font color="#D70040"><u>It is recommended that you have %d mosquitoes, treat each bottle with %.1f ug of insecticide and track mortality for a minimum of %d minutes</u></font>',
